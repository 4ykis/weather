    ...
    <div class="weather_block">
        ...
        <div class="weather_block-middle">
            <div class="weather_block-temp">
                <img class="weather_block-temp_img" :src="`http://openweathermap.org/img/wn/${data.weather[0].icon}@2x.png`"
        ...
        <div class="weather_block-bottom">
            ...
            <div class="weather_block-toggle">
                ...
                <div :title="isToggleActive ? 5 : 1" :class="['weather_block-toggle_inner', { 'active': isToggleActive }]"
